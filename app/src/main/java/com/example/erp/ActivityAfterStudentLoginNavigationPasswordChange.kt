...
class ActivityAfterStudentLoginNavigationPasswordChange : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_after_student_login_navigation_password_change)
    ...
    private fun changePassword() {
        db.collection("StudentLoginInfo").document(intent.getStringExtra("srnTxt").toString()).get()
