...
class ActivityAfterAdminLoginNavigationPasswordChange : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_after_admin_login_navigation_password_change)
    ...
    private fun changePassword() {
        db.collection("AdminLoginInfo").document(intent.getStringExtra("mailTxt").toString()).get()
